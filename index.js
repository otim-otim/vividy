...
app.use(logger);
let movies = [
  { id: 1, title: "hard target", actor: "van damme" },
...
app.put("api/movies/:id", (req, res) => {
  ...
  if (!movie)
    return res
      .status(404)
      .send(`requested movie is not available so you cant update anything`);
...
app.delete("api/movies/:id", (req, res) => {
  ...
  if (!movie)
    return res
      .status(404)
      .send(`requested movie is not available so you cant delete anything`);
